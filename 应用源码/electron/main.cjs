...
function handlers() {
  ...
  ipcMain.handle('set-theme', (_, theme) => { const value=['green-light','green-dark','blue-light','blue-dark','orange-light','orange-dark','pink-light','pink-dark','miaoxi-light','miaoxi-dark'].includes(theme)?theme:'green-light'; db.prepare("INSERT OR REPLACE INTO settings(key,value) VALUES('theme',?)").run(value); return bootstrap(); });
